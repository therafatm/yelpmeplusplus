...
def main(argv):
	...
	vect = TfidfVectorizer(strip_accents = 'ascii', norm = 'l2' , stop_words = 'english', ngram_range = (1,1), use_idf = False, smooth_idf = False)
	...
	print('Making some sweet predictions')
	...
	fp = open("Knearestneighbours.txt", "w")
